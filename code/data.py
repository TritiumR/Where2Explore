...
class SAPIENVisionDataset(data.Dataset):
    ...
    def __init__(self, primact_types, category_types, data_features, buffer_max_num, \
            ...
            no_true_false_equal=False, no_neg_dir_data=False, only_true_data=False, world_coordinate=False, additional_types=None):
    ...
    def load_data(self, data_list):
        ...
        for i in bar(range(len(data_list))):
            ...
            if cur_category not in self.category_types and cur_category not in self.additional_types:
                continue
