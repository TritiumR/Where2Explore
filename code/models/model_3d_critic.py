...
class Network(nn.Module):
    ...
    def forward_with_feature(self, pcs, dirs1, dirs2):
        pcs = pcs.repeat(1, 1, 2)
        whole_feats = self.pointnet2(pcs)
        ...
        pred_result_logits, feat = self.critic.forward_with_feature(net, input_queries)

        return pred_result_logits, whole_feats, feat
